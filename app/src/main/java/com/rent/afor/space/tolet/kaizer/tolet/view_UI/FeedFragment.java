...
public class FeedFragment extends android.support.v4.app.Fragment {
    ...
    private FeedContent[] statusValue(String response) throws JSONException {
        ...
        for (int i = 0; i < result.length(); i++) {
            ...
            feed[i] = new FeedContent(json.optString(Config.KEY_USER_IMAGE), json.optString(Config.KEY_USERNAME), json.optString(Config.STATUS_TIME), json.optString(Config.KEY_PRICE), json.optString(Config.KEY_SIZE_OF_FLAT), json.optString(Config.KEY_NO_OF_BED), json.optString(Config.KEY_NO_OF_BATH), json.optString(Config.KEY_FLOOR), json.optString(Config.KEY_LOCATION), json.optString(Config.KEY_OTHER_INFORMATION), json.optString(Config.KEY_POST_ID), json.optString(Config.KEY_RENT_DATE), json.optString(Config.KEY_USER_PHONE));
